...
public class PaymentRepositoryTest {
    ...
    void findByUserId_shouldReturnUserPayments() {
        ...
        Payment payment1 = createPayment(100000.0, LocalDateTime.now(), PaymentTypeEnum.TOP_UP,
                "Top up via bank transfer", PaymentStatusEnum.SUCCESS, userId1, null, null);
        Payment payment2 = createPayment(250000.0, LocalDateTime.now(), PaymentTypeEnum.KOST_PAYMENT,
                "Kost payment for May", PaymentStatusEnum.SUCCESS, userId1, ownerId, kostId);
        Payment payment3 = createPayment(300000.0, LocalDateTime.now(), PaymentTypeEnum.TOP_UP,
    ...
    void findByOwnerId_shouldReturnOwnerPayments() {
        ...
        Payment payment1 = createPayment(250000.0, LocalDateTime.now(), PaymentTypeEnum.KOST_PAYMENT,
                "Kost payment for May", PaymentStatusEnum.SUCCESS, userId1, ownerId1, kostId1);
        Payment payment2 = createPayment(300000.0, LocalDateTime.now(), PaymentTypeEnum.KOST_PAYMENT,
                "Kost payment for May", PaymentStatusEnum.SUCCESS, userId2, ownerId1, kostId2);
        Payment payment3 = createPayment(350000.0, LocalDateTime.now(), PaymentTypeEnum.KOST_PAYMENT,
    ...
    void findByDateBetween_shouldReturnPaymentsInDateRange() {
        ...
        Payment payment1 = createPayment(100000.0, now, PaymentTypeEnum.TOP_UP,
        ...
        // Act
        List<Payment> result = paymentRepository.findByDateBetween(yesterday, now);
